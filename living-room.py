...
for fileName in fileList:
    ...
    if "sensor" in fileName:
        ...
        for line in currentCsvFile:
            ...
            # Fill dictionary
            if "POWER2" in line[topicIndex] and "ON" in line[messageIndex]:
                try:
                    time = line[timeIndex]
...
csvFile = open(resultPath + "/living-room.csv", "w", newline='')
...
# Result
csvFile = open(resultPath + "/living-room-results.csv", "w", newline='')
writer = csv.writer(csvFile)
...
# Result per day
csvFile = open(resultPath + "/living-room-results-per-day.csv",
               "w", newline='')
writer = csv.writer(csvFile)
